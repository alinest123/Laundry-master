...
const PERMS: Record<string, Record<string, string[]>> = {
  super_admin:   { dashboard:["view"], articles:["view","create","edit","delete","publish"], categories:["view","create","edit","delete"], authors:["view","create","edit","delete"], tags:["view","create","edit","delete"], users:["view","create","edit","delete"], experts:["view","create","edit","delete"], appointments:["view","edit"], payments:["view"], zoom:["view","create","edit","delete"], newsletter:["view","create","delete"], media:["view","create","delete"], seo:["view","edit"], redirects:["view","create","edit","delete"], settings:["view","edit"], security_logs:["view"], audit_logs:["view"] },
  administrator: { dashboard:["view"], articles:["view","create","edit","delete","publish"], categories:["view","create","edit","delete"], authors:["view","create","edit","delete"], tags:["view","create","edit","delete"], users:["view","create","edit","delete"], experts:["view","create","edit","delete"], appointments:["view","edit"], payments:["view"], zoom:["view","create","edit","delete"], newsletter:["view","create","delete"], media:["view","create","delete"], seo:["view","edit"], redirects:["view","create","edit","delete"], audit_logs:["view"] },
  editor:        { dashboard:["view"], articles:["view","create","edit","delete","publish"], categories:["view","create","edit","delete"], authors:["view"], tags:["view","create","edit","delete"], experts:["view"], media:["view","create","delete"], seo:["view"] },
