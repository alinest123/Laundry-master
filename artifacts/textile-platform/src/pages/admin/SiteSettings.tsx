      ...
      <div className="max-w-2xl space-y-6">
        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {form.maintenanceMode && <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-amber-100 text-amber-700 text-xs rounded-full"><AlertTriangle className="w-3 h-3" /> Site is in maintenance</span>}
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {saved && <span className="inline-flex items-center gap-1 text-xs text-emerald-600 font-medium"><Check className="w-3.5 h-3.5" /> Saved</span>}
        </div>
      </div>
    </AdminLayout>
  );
