      ...
      <div className="min-h-screen bg-[#f5f5f2] flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          <div className="flex justify-center mb-4">
            <CheckCircle className="w-16 h-16 text-[#4a7c59]" />
          </div>
          <h1 className="text-2xl font-bold text-[#1c1c1c] mb-2">Check your inbox</h1>
    ...
    <div className="min-h-screen bg-[#f5f5f2] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-[#1c1c1c] mt-3">Create an account</h1>
          <p className="text-sm text-[#888] mt-1">Join the professional textile care community</p>
        </div>
        ...
        <p className="text-center text-sm text-[#888] mt-5">
          ...
          <Link href="/login" className="text-[#1c1c1c] font-semibold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
